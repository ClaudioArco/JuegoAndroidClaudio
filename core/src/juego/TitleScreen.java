...
public class TitleScreen extends ScreenAdapter {
    ...
    public void render(float delta) {
        ...
        game.batch.begin();
        game.font.draw(game.batch, "Bienvenido", Gdx.graphics.getWidth() * .25f, Gdx.graphics.getHeight() * .75f);
        game.font.draw(game.batch, "haz click en la pantalla para recoger las gotas. \nEvita las gotas de lluvia acida.", Gdx.graphics.getWidth() * .25f, Gdx.graphics.getHeight() * .50f);
